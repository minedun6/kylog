...
class SupplierDetailedStockDataTable extends DataTable
{
    ...
    /**
     * SupplierDetailedStockDataTable constructor.
...
//                return isset($packageItem->batch_number) ? $packageItem->batch_number : '<span class="label bg-red">' . config('kylogger.value_not_defined') . '</span>';
    ...
    {
        $query = $this->stock->getDetailedForDataTable($this->supplierParam);
...
//            'supplier_name' => ['title' => 'Supplier'],
    ...
    {
        return 'supplier_' . $this->supplierParam->id . '_detailed_stock_' . time();
    }
}
