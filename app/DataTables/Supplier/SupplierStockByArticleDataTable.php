...
class SupplierStockByArticleDataTable extends DataTable
{
    ...
    /**
     * SupplierStockByArticleDataTable constructor.
...
//            })
    ...
    {
        $query = $this->stock->getStockByArticleForDataTable($this->supplierParam);
...
//            'supplier_name' => ['title' => 'Supplier'],
    ...
    {
        return 'supplier_' . $this->supplierParam->id . '_stock_by_article' . time();
    }
}
