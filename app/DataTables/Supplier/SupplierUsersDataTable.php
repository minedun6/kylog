...
class SupplierUsersDataTable extends DataTable
{
    ...
    /**
     * SupplierUsersDataTable constructor.
     *
     * @param Datatables        $datatables
     * @param Factory           $viewFactory
     * @param CompanyRepository $supplier
     */
    public function __construct(Datatables $datatables, Factory $viewFactory, CompanyRepository $supplier)
    {
     ...
     * @return $this
     */
    public function forSupplier($supplier)
    {
        $this->supplierParam = $supplier;
    ...
    {
        return 'supplier_' . $this->supplierParam . '_users_' . time();
    }
    ...
    {
        return '<a href="' . route('admin.supplier.user.edit', [$this->supplierParam, $user]) . '" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i></a>';
    }
}
