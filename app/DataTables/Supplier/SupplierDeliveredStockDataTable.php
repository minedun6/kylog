...
class SupplierDeliveredStockDataTable extends DataTable
{
    ...
    /**
     * SupplierDeliveredStockDataTable constructor.
    ...
    {
        $query = $this->stock->getDeliveredForDataTable($this->supplierParam);
    ...
    {
        return 'supplier_' . $this->supplierParam->id . '_delivered_stock_' . time();
    }
}
