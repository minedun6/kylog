...
//                return (isset($company->name) && !empty($company->name)) ? $company->name : '<span class="label bg-red-haze">' . config("kylogger.value_not_defined") . '</span>';
                return $company->name;
            })
...
//                return (isset($company->address) && !empty($company->address)) ? $company->address : '<span class="label bg-red-thunderbird">' . config("kylogger.value_not_defined") . '</span>';
    ...
    {
        $query = $this->company->getForDataTable();
    ...
    {
        if (access()->allow('create-supplier')) {
            $buttons = [
                'createSupplier',
...
//            'users_count' => ['title' => 'Users Total', 'searchable' => false],
    ...
    {
        return '<a class="btn btn-xs btn-info" href="' . route('admin.supplier.show', $company) . '" ><i class="fa fa-search"></i></a>';
    }
    ...
    {
        return '<a class="btn btn-xs btn-warning" href="' . route('admin.supplier.edit', $company) . '" ><i class="fa fa-pencil"></i></a>';
    }
