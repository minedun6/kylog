<div class="form-group">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'JohnDoe ...']) !!}
</div>
...
<div class="form-group">
    <label for="">Supplier Customs Code</label>
...
<div class="fileinput {{ (isset($company)) ? 'fileinput-exists' : 'fileinput-new' }}" data-provides="fileinput"
     data-name="logo">
    @if(isset($company))
